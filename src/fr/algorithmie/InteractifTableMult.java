...
public class InteractifTableMult {
	...
	public static void main(String[] args) {
		...
		// On initialise la variable qui va nous servir à tester si le nombre
		// est entre 1 et 10 ou non
		boolean conditionArret = false;

		// On déclare la variable nb qui va permettre de stocker la valeur
